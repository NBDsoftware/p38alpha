...
plot.dccm(cij, margin.segments = prune.new$communities$membership,
          ...
          sub="Pair-wise residue CC using the MD simulation of 7PVU C162S with compound 38",
...
mtext("Betweenness Centrality Index for 7PVU C162S with compound 38", side=3, line=0.8, adj=0.5, cex=1)
