...
plot.dccm(cij, margin.segments = prune.new$communities$membership,
          ...
          sub="Pair-wise residue CC using the MD simulation of 7PV3 with compound SB203580",
...
mtext("Betweenness Centrality Index for 7PV3 with compound SB203580", side=3, line=0.8, adj=0.5, cex=1)
